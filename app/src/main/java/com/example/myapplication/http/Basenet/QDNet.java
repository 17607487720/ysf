...
public class QDNet {
    ...
    public static QDNet ins() {
        if (ins == null) ins = new QDNet();
        return ins;
    }
     ...
     * get请求
     */
    public static com.lzy.okgo.request.GetRequest get(String url) {
     ...
     * post请求
     */
    public static com.lzy.okgo.request.PostRequest post(String url) {
     ...
     * 添加全局公共请求参数
     */
    public QDNet addCommonHeaders(String key, String value) {
     ...
     * 添加全局拦截器
     */
    public QDNet addInterceptor(Interceptor interceptor) {
